...
const Register = () => {
  ...
  return (
    <div className="relative min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-12">
      <div className="glow-bubble h-[300px] w-[300px] bg-cosmic-800/10 bottom-1/4 right-1/4"></div>
      ...
      <div className="glass-panel w-full max-w-md rounded-2xl p-6 sm:p-8 relative z-10 border border-slate-800 bg-mystic-900/40 shadow-xl">
        <div className="text-center mb-6">
          ...
          <h2 className="font-serif text-2xl font-bold text-slate-150">Create Account</h2>
          <p className="text-xs text-slate-400 mt-1">Register to save multiple birth profiles and view histories</p>
        </div>
        ...
        <div className="text-center mt-6 text-xs text-slate-450">
          ...
          <Link to="/login" className="text-cosmic-400 font-semibold hover:text-cosmic-300 transition-colors">
            Login here
          </Link>
        </div>
      </div>
